...
ActionView::Helpers::AssetTagHelper.register_javascript_expansion :multifile => ['jquery.multifile.js']

ActionView::Helpers::AssetTagHelper.register_javascript_expansion :jquery_ui => ['jquery-ui-1.8.1.custom.min.js']
ActionView::Helpers::AssetTagHelper.register_stylesheet_expansion :jquery_ui => ['overcast/jquery-ui-1.8.1.custom.css']
